                ...
                <form class="login100-form" action="/user/dashboard" method="post">
                    ...
                    <div class="w-full">
                        <button type="button" class="d-flex btn btn-outline-info" style="margin: 0 auto;">
                            <a href="/">
                                <span class="mx-1"><img src="../public/programs/form/assets/images/google.svg" alt="google-logo" width="30" height="30"></span>
                    ...
                    <div class="flex-sb-m w-full p-t-5 m-l-30" style="justify-content: center;">
                        <div>
                            ...
                            <a href="./SignUp.jsp" class="text-primary font-weight-bold">
                                Sign Up
                            </a>
                        </div>
                    </div>
