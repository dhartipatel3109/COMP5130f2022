...
My Work : I developed different 5 model of our project (User, Admin, Merged, Department, Usercomplaint). And tried to make a user model to connect with controller. Overall we used MVC architecture for our project.I have used spring and java technology I have attached all file in my repository. 
